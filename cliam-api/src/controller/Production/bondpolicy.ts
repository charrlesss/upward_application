...
BondPolicy.post("/bond/get-bond-subline", async (req, res) => {
  try {
    res.send({
...
BondPolicy.post("/get-bond-acc-type", async (req, res) => {
  try {
...
BondPolicy.post("/add-bonds-policy", async (req, res:any) => {
...
BondPolicy.post("/update-bonds-policy", async (req, res:any) => {
  convertToPassitive(req);
...
BondPolicy.post("/delete-bonds-policy", async (req, res:any) => {
