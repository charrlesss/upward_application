...
///// new //////
FirePolicy.post("/fire/get-occupancy",async (req,res)=>{
  try {
    res.send({
...
FirePolicy.post("/fire/get-account",async (req,res)=>{
  try {
    res.send({
      message: "Successfully get data",
      success: true,
...
FirePolicy.post("/fire/get-mortgagee",async (req,res)=>{
  try {
    res.send({
      message: "Successfully get data",
      success: true,
...
FirePolicy.post("/add-fire-policy", async (req, res:any) => {
...
FirePolicy.post("/update-fire-policy", async (req, res:any) => {
  convertToPassitive(req);
  const { subAccountRef, clientIDRef, accountRef, policyNoRef, occupancyRef } =
    req.body;
  try {
...
FirePolicy.post("/delete-fire-policy", async (req, res:any) => {
