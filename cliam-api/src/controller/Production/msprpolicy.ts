...
MSPRPolicy.post("/mspr/get-account", async (req, res) => {
  try {
    res.send({
...
MSPRPolicy.post("/add-mspr-policy", async (req, res:any) => {
...
MSPRPolicy.post("/update-mspr-policy", async (req, res:any) => {
  convertToPassitive(req);
...
MSPRPolicy.post("/delete-mspr-policy", async (req, res:any) => {
