...
ID_Entry.post("/id-entry-client", async (req: Request, res: any) => {
...
ID_Entry.post("/id-entry-employee", async (req: Request, res: any) => {
...
ID_Entry.post("/id-entry-agent", async (req: Request, res: any) => {
...
ID_Entry.post("/id-entry-fixed-assets", async (req: Request, res: any) => {
...
ID_Entry.post("/id-entry-supplier", async (req: Request, res: any) => {
...
ID_Entry.post("/id-entry-others", async (req: Request, res: any) => {
...
ID_Entry.post("/entry-update", async (req, res: any) => {
...
ID_Entry.post("/id-entry-client-update", async (req: Request, res: any) => {
...
ID_Entry.post("/id-entry-employee-update", async (req: Request, res: any) => {


  if (
    !(await saveUserLogsCode(req, "edit", JSON.stringify(req.body), "employee"))
  ) {
    return res.send({ message: "Invalid User Code", success: false });
  }
...
ID_Entry.post("/id-entry-agent-update", async (req: Request, res: any) => {
...
ID_Entry.post("/id-entry-others-update", async (req: Request, res: any) => {
  ...
  try {
    delete req.body.NewShortName;
    await CreateOtherEntry(req.body);
    await saveUserLogs(req, req.body.entry_others_id, "update", "Entry Others");
...
ID_Entry.post("/id-entry-supplier-update", async (req: Request, res: any) => {


  if (
    !(await saveUserLogsCode(req, "edit", JSON.stringify(req.body), "supplier"))
  ) {
    return res.send({ message: "Invalid User Code", success: false });
  }
...
ID_Entry.post("/id-entry-generate-id", async (req: Request, res: any) => {
  res.send({
    success: false,
...
ID_Entry.get("/id-entry-subaccounts", async (req: Request, res: any) => {
  try {
    res.send({
      success: true,
...
ID_Entry.post("/entry-delete", async (req, res: any) => {
...
ID_Entry.post("/sub-account", async (req: Request, res: any) => {
  try {
...
ID_Entry.post("/mortgagee", async (req: Request, res: any) => {
  try {
    const mortgagee: any = await getMortgagee(req);
...
ID_Entry.post("/export-client-record", async (req: Request, res: any) => {
