...
import saveUserLogs, { getUserById } from "../../lib/save_user_logs";
...
CTPL.post("/add-ctpl", async (req: any, res: any) => {
...
CTPL.post("/delete-ctpl", async (req: Request, res: any) => {
...
CTPL.post("/update-ctpl", async (req: any, res: any) => {
  try {
    const user = await getUserById((req.user as any).UserId);
