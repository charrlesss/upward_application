...
Mortgagee.post("/add-mortgagee", async (req: Request, res: any) => {
...
Mortgagee.post("/delete-mortgagee", async (req: Request, res: any) => {
...
Mortgagee.post("/update-mortgagee", async (req: Request, res: any) => {
