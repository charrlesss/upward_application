...
SubAccount.post("/add-sub-account", async (req: Request, res: any) => {
...
SubAccount.post("/update-sub-account", async (req: Request, res: any) => {
  try {
    if (
...
SubAccount.post("/delete-sub-account", async (req: Request, res: any) => {
